...
export default function Reservaciones3() {
  const form = useForm({
      ...
      <div className="grid lg:grid-cols-2 gap-10 mt-10">
        ...
        <div className="border-t lg:border-t-0 lg:border-l border-slate-300 pl-0 lg:pl-10 pt-6 lg:pt-0">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-gray-800 text-sm">
            ...
            <p className="flex items-center gap-2"><MdOutlineKitchen /> Kitchen</p>
            <p className="flex items-center gap-2"><FaHotTub /> Hot tub</p>
            <p className="flex items-center gap-2"><MdOutlineMicrowave /> Microwave</p>
            <p className="flex items-center gap-2"><FaSwimmer /> Beach access</p>
            <p className="flex items-center gap-2"><FaCoffee /> Coffee maker</p>
            <p className="flex items-center gap-2"><FaParking /> Free parking</p>
            <p className="flex items-center gap-2"><FaShower /> Hot water</p>
            <p className="flex items-center gap-2"><FaTv /> LCD TV</p>
          </div>
        </div>
      </div>
